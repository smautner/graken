...
#  normal run...
######
set paraargs  -j 32 --bar  --joblog log1.txt   python main.py  --specialset True
...
--taskid 4 --v_radius 2 --v_distance 1  \
--shuffle -1 --i tasks85/task_{1} --out res_k10/{2}_{1} --pareto greedy  --contextsize 1
set argvalues ::: (seq 0 9) ::: (seq 50 50 950)
...
##########
set paraargs  -j 32 --bar  --joblog log2.txt   python main.py  --specialset True
set params --n_train 1000 --n_iter 10 --cipselector graph --cipselector_k 5000 \
--removedups True --filter_min_cip 1 --keepgraphs 30 --n_neighbors {2} \
--size_limiter 'lambda x:int\(x.mean\(\)\*1.4+.5\)' \
--taskid 4 --v_radius 2 --v_distance 1  --grammarname blablabla\
--shuffle -1 --i tasks85/task_{1} --out res_k5k/{2}_{1} --pareto greedy  --contextsize 1
set argvalues ::: (seq 0 9) ::: (seq 50 50 950)
